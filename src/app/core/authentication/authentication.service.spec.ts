  ...
  describe('login', () => {
    it('should return credentials', fakeAsync(() => {
      ...
      request.subscribe(credentials => {
        ...
        expect(credentials.subscriptionKey).toBeDefined();
      });
    }));
    ...
    it('should authenticate user', fakeAsync(() => {
      ...
      request.subscribe(() => {
        ...
        expect((<Credentials>authenticationService.credentials).subscriptionKey).toBeDefined();
        expect((<Credentials>authenticationService.credentials).subscriptionKey).not.toBeNull();
      });
    }));
